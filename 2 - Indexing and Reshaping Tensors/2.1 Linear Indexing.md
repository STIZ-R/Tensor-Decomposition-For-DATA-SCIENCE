...
```math
The columns are a_1 = \begin{bmatrix} 1 \\ 3 \end{bmatrix}, \quad a_2 = \begin{bmatrix} 2 \\ 4 \end{bmatrix}, \quad b_1 = \begin{bmatrix} 0 \\ 6 \end{bmatrix}, \quad b_2 = \begin{bmatrix} 5 \\ 7 \end{bmatrix}, \quad
```
