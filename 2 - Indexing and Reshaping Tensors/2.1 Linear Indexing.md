...
<br>
$i = \mathbb{T}_1(l) = 1 + \lfloor ((l - 1) mod ms_1)/s_1\rfloor = 1 + (l - 1) mod m$, <br>
$j = \mathbb{T}_2(l) = 1 + \lfloor ((l - 1) mod ns_2)/s_2\rfloor = 1 + \lfloor ((l - 1) mod nm)/m\rfloor$, <br>
$k = \mathbb{T}_3(l) = 1 + \lfloor ((l - 1) mod ps_3)/s_3\rfloor = 1 + \lfloor (l - 1)/mn\rfloor$, <br>
