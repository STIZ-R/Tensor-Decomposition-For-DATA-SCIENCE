...
```math
vec(X) = \begin{bmatrix}3 & 8 & 4 & 9 & 2 & 3 & 1 & 1 & 9 & 6 & 5 & 1 & 9 & 6 & 4 & 5 & 4 & 1\end{bmatrix}.
```
...
```math
vec(X) = \begin{bmatrix} x_{11\dots1} \\ x_{21\dots1} \\ . \\ . \\ . \\ x_{n_1n_2\dotsn_d} \end{bmatrix} = \begin{bmatrix} x_1 \\ x_2 \\ . \\ . \\ . \\ x_N \end{bmatrix}
```
With $N = \prod_{k=1}^dn_k$.
...
```math
vec(X) = \begin{bmatrix} 8 & -3 & 7 & 9 & -1 & 0 & 4 & 5 \end{bmatrix}
```
*(horizontaly for clarity)*
