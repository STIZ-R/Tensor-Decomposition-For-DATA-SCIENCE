...
> **Exercise 2.28** <br>
> For a #-way tensor $\mathbf{x}$ of size $m \times n \times p$, prove the following: <br>
> a) The mode-2 unfolding is equivalent to general matricization with $\mathfrak{R} = (2)$ and $\mathfrak{C} = (1,3)$. <br>
> b) The generalization matricization with $\mathfrak{R} = (1, \dots, d)$ and $\mathfrak{C} = \emptyset$.
