...
On this part, we just see that we can now verify the end shape of the matrix when we unfold it, for example, let take a 4-way tensor of size $3 \times 4 \times 3 \times 2$
