...
> **Exercise 3.3** <br>
> Let $\text{a } \in \mathb{R}^n, \text{ b } \in \mathbb{R}^m \text{ and c } \in \mathbb{R}^p$. Define $\mathbf{x} = a \circ b \circ c$ and $y = \mahtrm{vec}(\mathbf{x}).$ <br>
...
> **Exercise 3.4** <br>
> Prove $\lVert a \circ b \circ c\rVert² = \lVert a\rVert_2²\lVert b\rVert_2²\lVert c\rVert_2².$
