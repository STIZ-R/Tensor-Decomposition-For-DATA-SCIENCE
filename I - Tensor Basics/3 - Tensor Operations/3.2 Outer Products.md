...
> A 3-way TEnsor $\mathbf{x}$ is **rank 1** if it can be expressed as a vector outer product, *i.e.*, there exist vectors $\textbf{a, b, c}$ such that $\mathbf{x} = \textbf{a} \circ \textbf{b} \circ \textbf{c}$.   
